      ...
      <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
            <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12 mb-8">
                <span class=" text-blue-800 text-xs font-medium inline-flex items-center px-1 py-0 rounded-md dark:bg-gray-700 dark:text-blue-400 mb-2">
                    <dotlottie-player src="https://lottie.host/3fc815c4-04f0-4b93-a847-c7683a2a54f5/1NvNaCyZV6.json" background="transparent" speed="1" style="width: 100px; height: 100px;" loop autoplay></dotlottie-player>
                </span>
                <h1 class="text-gray-900 dark:text-white text-3xl md:text-5xl font-extrabold mb-2 font-GabaritoRegular">Welcome back!</h1>
                ...
                <span href="#" class="inline-flex justify-center items-center py-2.5 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                    Payroll, Divisi SDM
