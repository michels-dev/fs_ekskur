@extends('layouts.template')
      ...
      <div class="mx-auto max-w-7xl bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div id="defaultTabContent">
            <div class="hidden p-10" id="about" role="tabpanel" aria-labelledby="about-tab">
                <h2 class="mb-5 text-2xl font-extrabold tracking-tight text-gray-900 dark:text-white">Table Ekskur Temporer</h2>
                <div class="relative overflow-x-auto">
                  <table id="tableTemporer" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <div class="hidden p-4 bg-gray-100 rounded-lg md:p-8 dark:bg-gray-800 font-GabaritoRegular" id="services" role="tabpanel" aria-labelledby="services-tab">
              <h2 class="mb-5 text-2xl font-extrabold tracking-tight text-gray-900 dark:text-white font-GabaritoRegular">Form Input Ekskur Temporer</h2>
              <form action="{{ route('pages.store-ekskur-temporer') }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-6 mb-5">
                  <div class="relative z-0 w-full mb-5 group col-span-12 md:col-span-6">
                    <input type="text" name="npwp" id="npwp" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    <label for="npwp" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">NPWP</label>
                  </div>
                  <div class="relative z-0 w-full mb-5 group col-span-12 md:col-span-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                  ...
                  <div class="relative z-0 w-full mb-5 group col-span-12 md:col-span-4">
                    <input type="text" name="honor" id="honor" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peerr" placeholder=" " required />
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                  <div class="relative z-0 w-full mb-5 group col-span-12 md:col-span-4">
                    <input type="text" name="nama_bank" id="nama_bank" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    <label for="nama_bank" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Nama Bank</label>
                  </div>
                  <div class="relative z-0 w-full mb-5 group col-span-12 md:col-span-4">
                    <input type="text" name="norek" id="norek" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    <label for="norek" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Nomor Rekening</label>
                  </div>
                  <div class="relative z-0 w-full mb-5 group col-span-12 md:col-span-4">
                      <input type="text" name="atas_nama" id="atas_nama" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                      <label for="atas_nama" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Atas Nama</label>
                    </div>
                </div>
  ...
  <script>
    $(document).ready(function() {
      var table = $('#tableTemporer').DataTable({
          "paging": true,
          "lengthChange": true,
          "searching": true,
          "ordering": true,
    ...
    function deleteEkskurRutin(event, id, nama) {
      ...
      Swal.fire({
          ...
          if (result.isConfirmed) {
              window.location.href = "{{ url('pages/destroy-ekskur-temporer') }}/" + id;
